  ...
  <header class="flex flex-col gap-4 px-4 py-4 sm:gap-5 sm:px-6 sm:py-6 lg:px-8 lg:py-7 xl:flex-row xl:items-center xl:justify-between xl:py-8">
    <div class="relative w-full xl:max-w-2xl">
      ...
      <input
        ...
        class="h-12 w-full rounded-[10px] border border-slate-100 bg-white pl-12 pr-4 text-sm text-slate-700 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-slate-200 focus:ring-4 focus:ring-slate-100 sm:h-14 sm:pl-14 sm:pr-6 sm:text-base lg:h-[4.25rem] lg:pl-16 lg:pr-8 lg:text-[1.1rem]"
        :style="{
    ...
    <div class="grid w-full grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-center sm:justify-between sm:gap-4 xl:w-auto xl:flex-nowrap xl:justify-end">
      ...
      >
        ...
        <button
          ...
          class="flex h-10 flex-1 items-center justify-center rounded-xl px-3 py-2 text-xs font-bold transition sm:h-10 sm:min-w-[2.5rem] sm:flex-none sm:rounded-full sm:px-4"
          :class="isDark ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200' : 'text-slate-500 hover:bg-white/60 hover:text-slate-700'"
          @click="setTheme('dark')"
        >
      ...
      >
        <button
          ...
          class="flex h-10 flex-1 items-center justify-center rounded-xl px-3 py-2 text-xs font-bold transition sm:h-10 sm:min-w-[2.75rem] sm:flex-none sm:rounded-full sm:px-4"
      ...
      <button
        class="group relative flex h-11 w-full items-center justify-center rounded-2xl border text-slate-500 shadow-sm transition sm:h-12 sm:w-12 sm:rounded-full lg:h-[3.75rem] lg:w-[3.75rem]"
      ...
      <div
        class="flex h-11 w-full items-center justify-center overflow-hidden rounded-2xl border text-base font-bold shadow-sm sm:h-12 sm:w-12 sm:rounded-full lg:h-[3.75rem] lg:w-[3.75rem] lg:text-lg"
